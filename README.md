...
- [Tutorial: Running Julia on Jupyter Notebooks and Google Colab](https://youtu.be/zUfp4Jy6dmY)
- [Code Navigation using Ctags and Vim](https://www.youtube.com/watch?v=M6VUrPbqGi4)
- [Download ML Datasets from Baidu Drives using Curl](https://www.youtube.com/watch?v=EmhUDbjUwC0)
- [Spotify Recommendation Engine - Summer of Code Intro](https://www.youtube.com/watch?v=otrW8brCAiU)
